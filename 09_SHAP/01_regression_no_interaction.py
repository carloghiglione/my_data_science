# -*- coding: utf-8 -*-
"""
Created on Thu Mar  9 19:47:43 2023
...
###############################################################################
###############################################################################
# simulate some binary data and a linear outcome with no interaction term
...
# ensure the variables are not correlated and mean centered
print('Covariance')
print(np.cov(X.T))
print('Mean')
print(X.mean(0))
